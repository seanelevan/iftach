...
foreach($teammembers as $team){
  ...
  echo '<div style="border: 3px solid #FFFFFF;text-shadow: 10px 0px 30px rgb(0 0 0 / 10%);padding-top: 28px;color: #FFFFFF;margin-top: -8px;padding-left: 14px;font-weight: 600;margin-right: 30px;border-radius: 100%;font-size: 60px;float: left;padding-bottom: 0px;box-shadow: 0px 6px 18px rgb(0 0 0 / 15%);padding-right: 14px;/* line-height: 0px; */line-height: 27px;background-color: #2CAFE4;">“</div>';
