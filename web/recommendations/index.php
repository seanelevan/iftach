...
foreach($teammembers as $team){
  ...
  echo '<div style="font-family:\'Montserrat\';font-weight:400;font-size:34px;color:#2CAFE4;text-align:left;"><i><span style="color:#f5f5f5;">#'.$i.' &bull;</span> '.$team.'</div> <div style="margin-top:22px;font-family:\'Vollkorn\';font-weight:400;font-size:18px;line-height:28px;text-align:left;color:#444444;">'.$descriptions[$i-1].'</div> </div> </i> </div>';
